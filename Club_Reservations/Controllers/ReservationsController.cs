...
namespace Club_Reservations.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,ReservationDateTime,TableId,Description")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,ReservationDateTime,TableId,Description")] Reservation reservation)
        {
